...
%%
load('../results/graph_reg_parameter.mat');
%%
...
repetitions = 20;
running_time_graph_reg_random = zeros(repetitions,length(m));
%%
param.alpha = 0;
param.gamma = 0;
for ii=1:repetitions
    ...
    for i=1:length(m)
        ...
        running_time_graph_reg_random(ii,i) = toc;
    end
end
%%
results_path = '../results_time/';
mkdir(results_path);
save([results_path 'time_graph_reg_random.mat'],'running_time_graph_reg_random');
%%
