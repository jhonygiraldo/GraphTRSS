...
for ii=1:repetitions
    ...
    for i=1:length(m)
        ...
        for j=1:signals_t
            random_pattern(:,j) = sampling_patterns_tsitsvero(i,:)';
        end
...
%%
results_path = '../results_deterministic_sampling/';
mkdir(results_path);
save([results_path 'error_sobolev_batch_tsitsvero.mat'],'error_sobolev_batch_random',...
