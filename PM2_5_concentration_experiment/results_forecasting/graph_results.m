...
%%
qiu = load('error_qui_batch_random.mat');
sob = load('error_sobolev_batch_random.mat');
nni = load('error_NNI_random.mat');
tik = load('error_tikhonov_random.mat');
%%
line_width = 1.5;
marker_size = 6;
font_size = 21;
...
grid on;
saveas(gcf,[path_figures 'PM_25_experiment.svg']);